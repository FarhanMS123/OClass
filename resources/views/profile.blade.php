...
<html style="font-size: 16px;">
  <head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Username2">
    <meta name="description" content="">
    <meta name="page_type" content="np-template-header-footer-from-plugin">
    <title>Profile | OClass Official Learning Website</title>
...
<link rel="stylesheet" href="{{asset('css/profile.css')}}" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-custom-color-1 u-header u-header" id="sec-ec04"><div class="u-align-left u-clearfix u-sheet u-sheet-1"></div></header>
          ...
          <div class="u-layout-row">
            <div class="u-align-left u-container-style u-custom-color-1 u-layout-cell u-left-cell u-size-15 u-layout-cell-1" src="">
              <div class="u-container-layout u-container-layout-1">
                ...
                <span class="u-icon u-icon-circle u-icon-3"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 58 58" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-1465"></use></svg><svg class="u-svg-content" viewBox="0 0 58 58" x="0px" y="0px" id="svg-1465" style="enable-background:new 0 0 58 58;"><polygon style="fill:#EDEADA;" points="52,19 38,5 11,5 11,58 52,58 "></polygon><polygon style="fill:#C1BCA4;" points="11,5 38,5 47,14 47,0 6,0 6,53 11,53 "></polygon><g><path style="fill:#CEC9AE;" d="M19,26h25c0.552,0,1-0.447,1-1s-0.448-1-1-1H19c-0.552,0-1,0.447-1,1S18.448,26,19,26z"></path><path style="fill:#CEC9AE;" d="M19,18h10c0.552,0,1-0.447,1-1s-0.448-1-1-1H19c-0.552,0-1,0.447-1,1S18.448,18,19,18z"></path><path style="fill:#CEC9AE;" d="M44,32H19c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S44.552,32,44,32z"></path><path style="fill:#CEC9AE;" d="M44,40H19c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S44.552,40,44,40z"></path><path style="fill:#CEC9AE;" d="M44,48H19c-0.552,0-1,0.447-1,1s0.448,1,1,1h25c0.552,0,1-0.447,1-1S44.552,48,44,48z"></path></g><polygon style="fill:#CEC9AE;" points="38,5 38,19 52,19 "></polygon></svg></span>
                <a href="#" onclick="logout();" class="u-border-none u-btn u-button-style u-custom-color-1 u-hover-custom-color-2 u-btn-4">Logout</a>
                <span class="u-icon u-icon-circle u-text-black u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 492.5 492.5" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-9c12"></use></svg><svg class="u-svg-content" viewBox="0 0 492.5 492.5" x="0px" y="0px" id="svg-9c12" style="enable-background:new 0 0 492.5 492.5;"><g><path d="M184.646,0v21.72H99.704v433.358h31.403V53.123h53.539V492.5l208.15-37.422v-61.235V37.5L184.646,0z M222.938,263.129   c-6.997,0-12.67-7.381-12.67-16.486c0-9.104,5.673-16.485,12.67-16.485s12.67,7.381,12.67,16.485   C235.608,255.748,229.935,263.129,222.938,263.129z"></path></g></svg></span>
              </div>
            </div>
            <div class="u-container-style u-layout-cell u-right-cell u-size-45 u-layout-cell-2" src="">
              <div class="u-container-layout u-container-layout-2">
                <div class="card">
                <div class="u-image u-image-circle u-image-3" alt="" data-image-width="1280" data-image-height="851"></div>
                <h2 class="u-text u-text-default u-text-2">{{$user->name}}</h2>
                <h4 class="u-text u-text-default u-text-3">{{ucfirst($user->user_type)}} OClass</h4>
                <h4 class="u-text u-text-default u-text-4">OClass ID : {{$user->ocm_id}}</h4>
                <h3 class="u-text u-text-default u-text-5"> Email: {{$user->email}}</h3>
              </div>
              </div>
            </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-e090"><div class="u-align-left u-clearfix u-sheet u-sheet-1"></div></footer>
